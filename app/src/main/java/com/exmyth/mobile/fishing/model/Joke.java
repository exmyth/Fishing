...
public class Joke implements Serializable{
	...
	public Joke(String comment_ID, String comment_post_ID,
	            ...
	            String vote_positive, String vote_negative, String comment_counts) {
		super();
	...
	public String toString() {
		return "DuanZi [comment_ID=" + comment_ID + ", comment_post_ID="
				+ comment_post_ID + ", comment_author=" + comment_author
				+ ", comment_author_email=" + comment_author_email
				+ ", comment_author_url=" + comment_author_url
				+ ", comment_author_IP=" + comment_author_IP
				+ ", comment_date=" + comment_date + ", comment_date_gmt="
				+ comment_date_gmt + ", comment_content=" + comment_content
				+ ", text_content=" + text_content + ", comment_agent="
				+ comment_agent + ", vote_positive=" + vote_positive + ", comment_counts=" + comment_counts
