...
import com.exmyth.mobile.fishing.utils.AppInfoUtil;
			...
			MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
					...
					.callback(new MaterialDialog.ButtonCallback() {
						...
						public void onPositive(MaterialDialog dialog) {
							...
							startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/exmyth/JianDan")));
							dialog.dismiss();
						}
						...
						public void onNegative(MaterialDialog dialog) {
							...
							startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://weibo.com/exmyth1992")));
						}
